...
*/
        ...
        function allotherembeds_eachcategory(filterdisabled = false){
          ...
          var embed7 = new MessageEmbed()
            ...
            .addField("<:Rocket_prime:990332307774783548> **Most used Systems**", "> "+client.commands.filter((cmd) => cmd.category === "💪 Setup" && cmd.type.includes("system")).sort((a,b) => a.name.localeCompare(b?.name)).map((cmd) => `\`${cmd.name}\``).join("︲"))
